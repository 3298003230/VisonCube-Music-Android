  ...
  return (
    <View style={styles.main}>
      ...
      <ScrollView style={styles.content} keyboardShouldPersistTaps={'always'}>
        ...
        <Text selectable style={styles.text} >词语约定：本协议中的“本项目”指 VisonCube Music 移动版项目；“使用者”指签署本协议的使用者；“官方音乐平台”指对本项目内置的包括酷我、酷狗、咪咕等音乐源的官方平台统称；“版权数据”指包括但不限于图像、音频、名字等在内的他人拥有所属版权的数据。{'\n'}</Text>
