...
- Canonical LF-encoded certificate-file SHA-256: `C424C1C80B46F1505E3BFA5BA82406D1C0A67EB03DD83E5120A78E1F20EB0F2F`
...
The repository stores `visoncube-music-signing-backup.vcb`, an AES-256-GCM encrypted recovery archive. Because the repository is public, the recovery passphrase must never be committed, logged, or included in an Artifact. To restore on a new machine, run:
...
Only APKs passing `apksigner verify` with certificate SHA-256 fingerprint `9C951C4BBA399D21751F4B194E839DA3A49EFD60534CF9B3B9D35859A6D6BC95` are official releases. Raw PEM file hashes can differ after line-ending conversion, so the parsed certificate fingerprint is the cross-platform identity. The old `com.visoncube.music.mobile` application uses a different package identity and remains independently installed during the migration to `com.visoncube.music`.
